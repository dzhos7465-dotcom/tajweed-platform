...
const THEMES = {
  ...
  /* ── Лям в слове ٱللَّه ──
     Читается твёрдо или мягко в зависимости от огласовки ПЕРЕД словом.
     Раздел свой (lam): в вопросе варианты берутся из своего раздела, а
     здесь их всего два — так и должно быть, выбор между твёрдым и мягким. */
  lam_heavy:       { id: 'lam_heavy',      name: 'Твёрдый лям',               group: 'lam',  stage: 'course1', order: 18,
                    sign: 'Перед словом ٱللَّه стоит фатха или дамма — лям читается твёрдо, с оттенком «о». Так же и в начале речи.' },
  lam_light:       { id: 'lam_light',      name: 'Мягкий лям',                group: 'lam',  stage: 'course1', order: 19,
                    sign: 'Перед словом ٱللَّه стоит касра — лям читается мягко.' },
  madd_lin:        { id: 'madd_lin',        name: 'Мадд лин (мягкий)',         group: 'madd', stage: 'course1', order: 17,
                    sign: 'Мягкая буква — و или ي с сукуном, а перед ней фатха, и стоит она прямо перед последней буквой слова. Удлинение возникает при остановке. Если перед و дамма или перед ي касра — это буква мадда, а не мягкая.' },
};
...
const EXAMPLES = [
  ...
  // Мадд лин (мягкий) — و или ي с сукуном, перед ними фатха, при остановке.
  // Все слова из урока, все чистые. В материале их только шесть — придумывать
  // нельзя, добор из мусхафа отдельно.
  { id: 'ex_mln_1', text: 'خَوۡفٍ',    themes: ['madd_lin'] },
  { id: 'ex_mln_2', text: 'ٱلۡمَوۡتُ',  themes: ['madd_lin'] },
  { id: 'ex_mln_3', text: 'قَوۡمٍ',    themes: ['madd_lin'] },
