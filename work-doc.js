...
(function () {
  ...
  function advice(review, r) {
    ...
    if (qShare === 1 && qAll >= 4) {
      lines.push({ mark: '✓', color: OK,
        text: '<b>В вопросах нет ни одной ошибки.</b> Правила названы верно все до одного — это признак твёрдого навыка, а не случайного угадывания.' });
    } else if (strong.length) {
      lines.push({ mark: '✓', color: OK,
        text: '<b>Держится твёрдо:</b> ' + strong.slice(0, 4).map(esc).join(', ') +
              ' — здесь ошибок нет, это признак твёрдого навыка, а не случайного угадывания.' });
    }
    // ══════════════════════════════════════════════════════════════════════
