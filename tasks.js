...
/* ── ДОЛИ ВИДОВ ЗАДАНИЙ ───────────────────────────────────────────────
   ...
   доступные баллы по этим числам.
     ...
     вопрос о правиле    3   выбор из четырёх
     нулевой курс        2   ступень ниже: буквы и знаки, любые задания
...
/* ── НУЛЕВОЙ КУРС В СМЕШАННОЙ РАБОТЕ ──────────────────────────────────
   У него не относительная доля, а ТВЁРДАЯ: пятая часть теста, то есть
   около 16 баллов из ста, когда в работе есть чтение.
