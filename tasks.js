...
/* ── ВЕС ЗАДАНИЙ НУЛЕВОГО КУРСА ───────────────────────────────────────
   ...
   Вопрос нулевого курса — 2 против 3 у правила: полторы буквы за одно
   правило. Распределение — 3, то есть ровно как один вопрос о правиле,
   хотя внутри шесть решений: задание тяжелее вопроса, но материал тот же,
   начальный, и подниматься выше правил ему незачем.
