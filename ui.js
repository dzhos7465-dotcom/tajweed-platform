...
(function () {
  ...
  function renderResult(r) {
    ...
    /* Откуда взялась сотня. Без этой строки крупное число выглядит
       ...
       И ещё одно, важнее: когда в работе есть чтение, крупное число —
       это ТОЛЬКО тест, то есть четыре пятых итога. Ученик читал его как
       оценку и уходил с неверным представлением: 84 у него в голове
       становились восемьюдесятью четырьмя, хотя итог мог выйти и выше,
       и ниже. Говорим об этом прямо, рядом с числом, а не в примечании
